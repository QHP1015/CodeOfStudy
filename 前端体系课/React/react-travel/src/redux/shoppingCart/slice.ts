...
export const getShoppingCart: any = createAsyncThunk("shoppingCart/getShoppingCart", async (jwt: string, thunkAPI) => {
...
export const checkout: any = createAsyncThunk("shoppingCart/checkout", async (jwt: string, thunkAPI) => {
